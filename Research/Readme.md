...
This folder contains a collection of best-practice routines and guidelines for research @AG.DPP, see the Summary below. 
To contribute, just edit existing documents or create new ones on your own.
Please adhere to the guidelines summarized in [Contribution.md](Contribution.md).
Make sure to adhere to the formatting guidelines outlined below.
