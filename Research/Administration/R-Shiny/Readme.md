...
- **Norms**
  - This folder contains the normative values for the overall sample and the different selectable subgroups in .csv files. The folder and file names are used to construct the options that can be selected in the section specific norms.
...
<img src="Resources/selecter_construction.png" width="100%">
