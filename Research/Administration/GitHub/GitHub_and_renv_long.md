...
For readers who are relatively familiar with certain topics covered such as [R and R Studio](https://github.com/alex-strobel/DPP-LabManual/wiki/R-and-RStudio), [R Markdown](https://github.com/alex-strobel/DPP-LabManual/wiki/R-Markdown) and [GitHub](https://github.com/alex-strobel/DPP-LabManual/wiki/GitHub), it may be more convenient to read the [short version](https://github.com/alex-strobel/DPP-LabManual/blob/main/Research/Administration/GitHub/GitHub_and_renv/GitHub_and_renv_short.md) (approx. 3200 words, reading time 10-15 min unless trying out things).
