...
+ **Struktur:** Allgemeine Dokumentationen sollten an zentraler Stelle (z.B. oberste Hierarchie-Ebene auf dem Gruppenlaufwerk) abgelegt werden; sämtliche Dokumente sollten eindeutig und einheitlich benannt werden; bei vielen Dokumenten kann es sich lohnen, eine Übersicht zu führen (Liste aktuell halten -> verantwortliche Person bestimmen)
+ **Relevante Dokumente**
  ...
  + *Skripte:* z.B. SPSS/SAS/Stata, R-Code, Matlab, Python etc.; relevante Informationen in Header und In-line Kommentaren in einem Auflösungsgrad dokumentieren, der die Handhabung der Skripte durch Dritte möglich macht 
...
+ **Vorgehen** bei der Datenarchivierung: 
  ...
  + Datenaufbereitung (analog zur „Checkliste für die Ablage von Daten auf dem Gruppenlaufwerk“ in Abschnitt 3 „Datenorganisation“<!-- wo findet sich dieser Abschnitt?-->) 
