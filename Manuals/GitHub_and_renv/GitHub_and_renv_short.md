...
If you are relatively new to R/R Studio, R Markdown and GitHub, it might be better to read the [long version](https://github.com/alex-strobel/DPP-LabManual/blob/main/Manuals/GitHub_and_renv/GitHub_and_renv_long.md) (approx. 5500 words, reading time 20-30 min unless trying out things).
