...
This is the long version (approx. 5500 Words, reading time 20-30 min unless you are trying out what is described here in parallel) of the description on how to use GitHub and the `renv` package cor collaboratively working on R projects. 
For readers who are relatively familiar with certain topics covered such as relatively R/RStudio, R Markdown and GitHub, it may be more convenient to read the [short version](https://github.com/alex-strobel/DPP-LabManual/blob/main/Manuals/GitHub_and_renv/GitHub_and_renv_short.md) (approx. 3200 words, reading time 10-15 min unless trying out things).
